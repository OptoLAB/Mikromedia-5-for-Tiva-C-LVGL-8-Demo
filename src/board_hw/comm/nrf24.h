...
//CS
#define nRF24_CS_LO()     MAP_GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_6, 0)
#define nRF24_CS_HI()     MAP_GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_6, GPIO_PIN_6)
//CE
#define nRF24_CE_LO()     MAP_GPIOPinWrite(GPIO_PORTG_BASE, GPIO_PIN_3, 0)
#define nRF24_CE_HI()     MAP_GPIOPinWrite(GPIO_PORTG_BASE, GPIO_PIN_3, GPIO_PIN_3)
//INT
//PORTG, GPIO_PIN_2, not used
...
#define nRF24_RX_ON()   nRF24_CE_HI();
#define nRF24_RX_OFF()  nRF24_CE_LO();
#endif // __NRF24_H
