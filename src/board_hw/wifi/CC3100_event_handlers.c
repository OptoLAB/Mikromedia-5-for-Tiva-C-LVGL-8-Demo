...
//#include "board_hw/wifi/CC3100_event_handlers.h"
...
void CC3100_GeneralEventHandler(SlDeviceEvent_t *pDevEvent)
{
    /*
...
void CC3100_WlanEventHandler(SlWlanEvent_t *pWlanEvent)
{
    if(pWlanEvent == NULL)
...
void CC3100_NetAppEventHandler(SlNetAppEvent_t *pNetAppEvent)
{
...
void CC3100_HttpServerCallback(SlHttpServerEvent_t *pHttpEvent, SlHttpServerResponse_t *pHttpResponse)
{
    /*
...
void CC3100_SockEventHandler(SlSockEvent_t *pSock)
{
    if(pSock == NULL)
